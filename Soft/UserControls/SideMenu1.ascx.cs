...
public partial class Admin_UserControls_SideMenu1 : System.Web.UI.UserControl
{
        ...
        if (!IsPostBack)
        {
            ...
            //{
              //  Soft = Request.Cookies["STFP"];
                ...
                //if (!(Soft.Values["Type"].ToString().Equals("Soft"))) { menu(); }
                //else { fillData(); }
           // }
        }
    }
    ...
    //    //if (Soft.Values["Type"].ToString() != "Admin1")
    //    //{
    //        query = "select tbl_Menu.*,(select count(*) from tbl_Menu as p inner join tbl_EmpRoles as r on p.MenuId = r.PageID where p.ParentId = tbl_Menu.MenuId and r.UserId = " + Soft.Values["UserId"].ToString() + ") as cc " +
    //           " from tbl_Menu inner join tbl_EmpRoles on tbl_menu.MenuId = tbl_EmpRoles.PageID where tbl_Menu.ParentId = 0 and tbl_EmpRoles.UserId=" + Soft.Values["UserId"].ToString() + "";
    ...
    //                query += " and tbl_EmpRoles.UserId=" + Soft.Values["UserId"].ToString() + " and tbl_Menu.isDelete=0 ";
    //                //if (s == true)
    //                //    query += " and IsMobile=1";
    //                query += " order by tbl_Menu.Position";
    //            //}
