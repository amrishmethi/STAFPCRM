...
public partial class Soft_Payroll : System.Web.UI.Page
{
    ...
    public void FillEmp_Data(string Emp_id)
    {
        ...
        if (dsGet.Tables[0].Rows.Count > 0)
        {
            ...
            chkDOL.Checked = (dsGet.Tables[0].Rows[0]["DOL1"].ToString() != "") ? true : false;
        ...
        if (dsGet.Tables[2].Rows.Count > 0)
        {
            ...
            if (Convert.ToBoolean(dsGet.Tables[2].Rows[0]["IS_NSA"]))
            {
                ...
                txtKM.Text = dsGet.Tables[2].Rows[0]["NSA_KM"].ToString();
            ...
            drpNoOfSunday.SelectedValue = dsGet.Tables[2].Rows[0]["NoOfSunday"].ToString();
            ...
            drpOverTime.SelectedValue = dsGet.Tables[2].Rows[0]["OTApplicable1"].ToString();
        }
        #endregion
