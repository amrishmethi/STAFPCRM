<%@ Page Title="" Language="C#" MasterPageFile="~/Soft/AdminMaster.master" AutoEventWireup="true" CodeFile="IPAdrs.aspx.cs" Inherits="Soft_IPAdrs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    <section class="content-header" style="height: 2.5em;">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/Soft/IPAdrs.aspx" class="active">IP Address</a></li>
        </ol>
    </section>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-md-4">
                                <label class="control-label">IP Address<span style="color: #ff0000">*</span></label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtIpAdrs"
