<%@ Page Title="" Language="C#" MasterPageFile="~/Soft/AdminMaster.master" AutoEventWireup="true" CodeFile="employeestatusm.aspx.cs" Inherits="Soft_employeestatusm" %>


<%@ Register Src="~/Soft/UserControls/DTCSS.ascx" TagPrefix="uc1" TagName="DTCSS" %>
<%@ Register Src="~/Soft/UserControls/DTJS.ascx" TagPrefix="uc1" TagName="DTJS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Employee Status(STAFP)</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    ...
    <section class="content-header" style="height: 2.5em;">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/Soft/orderreportsp.aspx" class="active">Employee Status</a></li>
        </ol>
    </section>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <label>Month</label>
                                <asp:TextBox ID="mnth" runat="server" type="text" class="form-control datepicker" autocomplete="off" />
                            </div>
