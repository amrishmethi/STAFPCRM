                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="5px" class="table table-bordered table-striped">
                        <asp:UpdatePanel ID="upd" runat="server">
                            <ContentTemplate>
                                ...
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkBS" runat="server" ClientIDMode="Static" onclick="return OptionsSelected(this,'Body_txtBasicsalary')" AutoPostBack="true" /></td>
                                    <td>
                                        <label class="control-label">Basic Salary</label></td>
                                    <td>
                                        <asp:RadioButton ID="RBBSFixed" runat="server" Text="Fixed" GroupName="BS" Checked="true" OnCheckedChanged="RBBS_CheckedChanged" AutoPostBack="true" />
                                        &nbsp; &nbsp;<asp:RadioButton ID="RBPER" runat="server" Text="Per(%)" GroupName="BS" OnCheckedChanged="RBPER_CheckedChanged" ClientIDMode="Static" AutoPostBack="true" /></td>
                                    <td>
                                        <asp:TextBox ID="txtBasicsalary" runat="server" CssClass="form-control" Enabled="false" Text="0"   onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPFSelfValue" runat="server" CssClass="form-control" placeholder="Employee" Enabled="false"></asp:TextBox>
                                        <br />
                                        <asp:TextBox ID="txtPFCompValue" runat="server" CssClass="form-control" placeholder="Employer" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtESICSelfValue" runat="server" CssClass="form-control" placeholder="Employee" Enabled="false"></asp:TextBox>
                                        <br />
                                        <asp:TextBox ID="txtESICCompValue" runat="server" CssClass="form-control" placeholder="Employer" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtHRAValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TxtwashingAllowanceValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMediaclValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtConveyanceValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDPayValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFoodAllValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtOthersValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTDSValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDeductOtherValue" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkOverTimePH" runat="server" AutoPostBack="true" OnCheckedChanged="chkOverTime_CheckedChanged" /></td>
                                    <td>
                                        <label class="control-label">Over Time ( % Per Hour Salary)</label></td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:TextBox ID="txtOverTimePH" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                                    <td>&nbsp;</td>
                                </tr>
                            </ContentTemplate>
                            <%-- <Triggers>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <asp:TextBox ID="txtCTC" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                        </tr>
                    </table>
                </div>
            </div>
                            ...
                            <asp:UpdatePanel ID="updGender" runat="server">
                                <ContentTemplate>
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList ID="drpGender" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="drpGender_SelectedIndexChanged">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList ID="drpMarriedStatus" runat="server" CssClass="form-control select2" OnSelectedIndexChanged="drpMarriedStatus_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="drpMarriedStatus" EventName="SelectedIndexChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
                            <div class="col-md-3">
                                <label class="control-label">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="Server">
    ...
    <script> 
            function OptionsSelected(me, valuee) {
            debugger
            ...
            document.getElementById(valuee).innerText = "0";
        }
    </script>
