<%@ Page Title="" Language="C#" MasterPageFile="~/Soft/AdminMaster.master" AutoEventWireup="true" CodeFile="EmployeeBookAssign.aspx.cs" Inherits="Soft_EmployeeBookAssign" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/Soft/UserControls/DTCSS.ascx" TagPrefix="uc1" TagName="DTCSS" %>
<%@ Register Src="~/Soft/UserControls/DTJS.ascx" TagPrefix="uc1" TagName="DTJS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Employee Book Assign (STAFP)</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
    ...
    <section class="content-header" style="height: 2.5em;">
        <h1>Book Assign (Employee)</h1>
        <ol class="breadcrumb">
            <li><a href="/Soft/Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="/Soft/EmployeeBookassign.aspx" class="active">Book Assign (Employee)</a></li>
        </ol>
    </section>
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeA">
                                            <td>
                                                ...
                                                <asp:HiddenField ID="hddGroups" Value='<%# Eval("Books")  %>' runat="server" />
                                            </td>
                                            ...
                                            <td style="text-align: left;"><%#Eval("Books") %></td>
                                            <td style="text-align: left;">
                                                    ...
                                                    <HeaderTemplate>
                                                        <table style="width: 100%; height: 500px; overflow-y: scroll; display: block; overflow-x: auto;">
                                                            <tr>
                                                                ...
                                                                <th style="width: 50%;">Book Type</th>
                                                            </tr>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <asp:HiddenField ID="hddMSNO" runat="server" Value='<%#Eval("BkISNo") %>' />
                                                            <asp:HiddenField ID="hddPartyId" runat="server" Value='<%#Eval("PartyId") %>' />
                                                            <td>
                                                                <asp:Label ID="lblMSNAME" runat="server" Text='<%# Eval("BkName") %>' />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
