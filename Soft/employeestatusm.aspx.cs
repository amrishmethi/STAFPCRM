...
public partial class Soft_employeestatusm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            mnth.Text = DateTime.Now.ToString("dd/MM/yyyy").Replace('-', '/');
    ...
    {
        cmd.CommandText = "PROC_EMPLOYEEWORKINGSTATUS";
        ...
        cmd.Parameters.AddWithValue("@DT", data.ConvertToDateTime(mnth.Text));
        DataSet ds = data.SP_getDataSet(cmd);
        ViewState["EMPLOYEEWORKINGSTATUS"] = ds;
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        string fileName = "attachment; filename=EmployeeStatus.xls";
        Response.ClearContent();
